        ...
        <div class="row">
            <div class="input-field col s12 m6">
                ...
                <select name="paket_jemput" id="paketjemputs">
                    ...
                    <option data-hargajemput="0" value="1-0-Terminal Kediri Kota">Terminal Kediri Kota -> Pare (free)
                    </option>
                    <option data-hargajemput="0" value="2-0-Stasiun Kediri Kota">Stasiun Kediri Kota -> Pare (free)
                    </option>
                    <option data-hargajemput="125000" value="3-125000-Bandara Juanda SBY">Bandara Juanda Surabaya -> pare
                        (125k)</option>
                </select>
            ...
            <div class="input-field col s12 m6">
                ...
                <select name="paket_pulang" id="paketpulangs">
                    ...
                    <option data-harga="79000" value="1-79000-Terminal Kediri Kota">Pare -> Terminal kediri kota (79k)
                    </option>
                    <option data-harga="79000" value="2-79000-Stasiun Kediri Kota">Pare -> Stasiun kediri kota (79k)
                    </option>
                    <option data-harga="125000" value="3-125000-Bandara Juanda Surabaya">Pare -> Bandara Juanda Surabaya (125k)
                    </option>
                </select>
