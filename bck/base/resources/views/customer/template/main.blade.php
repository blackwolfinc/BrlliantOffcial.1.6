...
<body>
    ...
    <div class="buton-khusus-2 fixed-action-btn horizontal click-to-toggle">
          <a class="btn-floating btn-large waves-effect waves-light"  href="https://wa.link/pjtsbx" class="btn-floating  white"><img class="btnimgbesar" src="{{ asset('customer/ImageAsset/WA2.png')}}" alt=""></a>
      </a>
      <ul>
      </ul>
    </div>
