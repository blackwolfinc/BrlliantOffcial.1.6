    ...
    <div class="row validasi-wrap">
        <div class="col s12">
          ...
          <div class="input-field inline">
            ...
            <label for="email_inline">ID Pendaftaran</label>
            <span class="helper-text" data-error="wrong" data-success="right">*masukkan ID Pendaftaran yang terdapat pada file pdf form registrasi </span>
          </div>
        </div>
      </div>
