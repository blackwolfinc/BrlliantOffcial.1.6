...
<div class="selogan2 bg-2">
    <h3 class="h3-khusus2"><b>PROGRAM REGULER</b></h3>
</div>
...
<!--<div class="koter-wraper">-->
<!--    <div class="kloterTitle bg-2">-->
<!--        <h3 class="c-teal4 c-wth">Kalender Akademik Paket Extra Online {{date('Y')}}</h3>-->
<!--    </div>-->
<!--    <div class="kloterhead">-->
<!--        <h3 class="c-teal2"><b>BRILLIANT ENGLISH COURSE </b></h3>-->
<!--        <h3 class="c-teal6 c-teal">KAMPUNG INGGRIS PARE </h3>-->
...
<div class="selogan2 bg-2">
    <h3 class="h3-khusus2"><b>PROGRAM ONLINE</b></h3>
</div>

    <div id="daftarlain" class="" style="padding: 5vw;">
        
        <div class="row">
            @foreach ($paket1 as $item)
            <div class=" judul-card2 col s12 m6 l6 xl3">
                <div class="card cardwraper-daftar2 ">

                    <div class="card-content atas-judul-card bg-white text-white ">
                        <center>
                            <h4><b> {{ $item->nama_paket }} </b></h4>
                            <h5 class=''>{{ $item->durasi }} {{ strtoupper($item->satuan) }}
                               </h5>
                        </center>
                    </div>
                    <div class="card-content angka-total center">
                    ...
                    <ul>
                        ...
                        <div class="card-content center">
                            <div class="row">
                                <div class="col s12">
                                    <a href="{{ route('daftaronline',$item->id) }}" class='btn '>Daftar Sekarang</a>
                                </div>
                            </div>
                        </div>
