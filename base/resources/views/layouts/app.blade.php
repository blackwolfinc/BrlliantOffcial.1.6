      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a class="nav-link" href="{{ route('manage_kloter') }}"><i class="fas fa-school"></i> <span>Manage Periode (Reguler)</span></a></li>
            <li><a class="nav-link" href="{{ route('manage_kloter_online') }}"><i class="fas fa-school"></i> <span>Manage Periode (ONLINE)</span></a></li>
            <li><a class="nav-link" href="{{ route('manage_bank') }}"><i class="fas fa-money-bill"></i> <span>Manage Bank</span></a></li>
            <li><a class="nav-link" href="{{ route('manage_paket') }}"><i class="fas fa-list"></i> <span>Manage Program (Reguler)</span></a></li>
            <li><a class="nav-link" href="{{ route('manage_paket_online') }}"><i class="fas fa-list"></i> <span>Manage Program (ONLINE)</span></a></liProgram
