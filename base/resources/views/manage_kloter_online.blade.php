...
@section('title','Manage Periode Online')
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="card">
            <div class="card-body">
              <p class="alert alert-primary text-center" style="width:100%;">Periode Online</p>
              <br>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form action="{{ route('manage_kloter_online_action') }}" method="post">
            @csrf
