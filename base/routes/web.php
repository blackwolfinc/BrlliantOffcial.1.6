...
Route::get('/onlinedaftar-{id}', [App\Http\Controllers\UserController::class, 'daftaronline'])->name('daftaronline');
...
Route::get('/manage-paket-online', [App\Http\Controllers\HomeController::class, 'manage_paket_online'])->name('manage_paket_online');
Route::post('/manage-paket-online-tambah-action', [App\Http\Controllers\HomeController::class, 'manage_paket_online_tambah_action'])->name('manage_paket_online_tambah_action');
...
Route::get('/manage-kloter-online', [App\Http\Controllers\HomeController::class, 'manage_kloter_online'])->name('manage_kloter_online');
Route::post('/manage-kloter-online', [App\Http\Controllers\HomeController::class, 'manage_kloter_online_action'])->name('manage_kloter_online_action');
