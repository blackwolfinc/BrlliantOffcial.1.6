...
class HomeController extends Controller
{
    ...
    {
        $paket = Paket::where(['online'=>'0'])->get();
        return view('manage_paket',compact('paket'));
    }
    public function manage_paket_online()
    {
        $paket = Paket::where(['online'=>'1'])->get();
        return view('manage_paket_online',compact('paket'));
    }
    ...
    public function manage_paket_online_tambah_action(Request $request)
    {
        if ($request->id) {
            Paket::where(['id'=>$request->id])->update([
                'nama_paket' => $request->nama_paket,
        ...
        // return redirect()->route('manage_paket_online');
        return redirect()->back();
    }
    ...
    {
        $ref = DB::table('kloter')->where(['active'=>'1','online'=>'0'])->get();
        $ref2 = DB::table('kloter')->where(['active'=>'0','online'=>'0'])->get();
        return view('manage_kloter',compact(['ref','ref2']));
    }
    public function manage_kloter_online()
    {
        $ref = DB::table('kloter')->where(['active'=>'1','online'=>'1'])->get();
        $ref2 = DB::table('kloter')->where(['active'=>'0','online'=>'1'])->get();
        return view('manage_kloter_online',compact(['ref','ref2']));
    }
    public function manage_kloter_online_action(Request $request)
    {
